...
exports.getUrls =
  exports.save =
  exports.writeTestsToFiles =
  exports.parseFailedAngularTestOutput =
  exports.saveTestsWithErrors =
  exports.filterFiles =
  exports.findFiles =
  exports.createFile =
  exports.doesFileExist =
  exports.printSummary =
  exports.checkIfAngularTestsPass =
  exports.checkIfJestTestPasses =
  exports.tsAndHtmlFromFile =
  exports.groupFilesByDirectory =
  exports.getInput =
  exports.runTest =
  exports.runTestErrorOutput =
  exports.runJestTest =
  exports.fixErrors =
  ...
  exports.getTestVersion =
  exports.getFileContent =
  exports.getDiff =
  exports.getChangedFiles =
  exports.debug =
  exports.grabFromConfig =
  exports.detectTypescriptExtension =
  exports.detectTsconfigTarget =
  exports.detectTestFramework =
  exports.detectProjectType =
  exports.detectWorkspaceDir =
    void 0;
...
function detectWorkspaceDir() {
  ...
  if (configWorkspaceDir && fs.existsSync(packageJsonPath)) {
    ...
    debug(
      "Looks like it wasn't configured in deepunit.config.json, but is in the current working directory",
      verboseLogging,
    );
    workspaceDir = '';
  } else {
  ...
  debug(
    'Detected repo located at workspaceDir: ' + workspaceDir,
    verboseLogging,
  );
}
...
function detectTsconfigTarget() {
  ...
  while (tsconfigPath) {
    if (fs.existsSync(tsconfigPath)) {
      ...
      try {
        let tsconfigJson = typescript_1.default.parseConfigFileTextToJson(
          '',
          contents,
        );
        scriptTarget = (
          (_b =
            (_a = tsconfigJson.config) === null || _a === void 0
              ? void 0
              : _a.compilerOptions) === null || _b === void 0
            ? void 0
            : _b.target
        )
          ? (_d =
              (_c = tsconfigJson.config) === null || _c === void 0
                ? void 0
                : _c.compilerOptions) === null || _d === void 0
            ? void 0
            : _d.target
          : undefined;
        if (
          (_f =
            (_e = tsconfigJson.config) === null || _e === void 0
              ? void 0
              : _e.compilerOptions) === null || _f === void 0
            ? void 0
            : _f.jsx
        ) {
        ...
        if (tsconfigPath != null) {
          // @ts-ignore
          tsconfigPath = (
            (_g = tsconfigJson.config) === null || _g === void 0
              ? void 0
              : _g.extends
          )
            ? path.join(
                path.dirname(tsconfigPath),
                (_h = tsconfigJson.config) === null || _h === void 0
                  ? void 0
                  : _h.extends,
              )
            : null;
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      const response = mockGenerationApiResponse
        ? mockedGeneration
        : yield axios_1.default.post(generateApiPath, data, { headers });
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    while (attempts < maxAttempts && matches.length > 0) {
      ...
      if (match === undefined) {
        ...
        console.log(matches);
        console.log(
          "match was undefined, I don't think this could ever happen, but if it did it could cause an infinite loop",
        );
        contiues++;
        continue;
      } else if (
      ...
      const errorString =
        testingFramework === 'jasmine' ? `${match[0]}${match[1]}` : match;
      ...
      try {
        counter++;
        const response =
          /*mockFixingApiResponse ? {data: {fixed_test: 'mocked fixed test code'}} :*/ yield axios_1.default.post(
            fixErrorApiPath,
            data,
            { headers },
          );
    ...
    if (matches.length > 0) {
      ...
      console.log(
        `Unable to fix all errors, resetting any uncommitted changes in ${file}...`,
      );
      ...
      return {
        ...
        runResults: errors,
        apiError: false,
        fixedTest: fixedTestCode,
      };
    } else {
      console.log(
        'attempts: ' + attempts + ' not its not: ' + (maxAttempts - 1),
      );
    }
    return {
      fixedAllErrors: true,
...
function runJestTest(file) {
  ...
  let result;
  try {
    result = (0, child_process_1.execSync)(
      `npx jest --json ${file} --passWithNoTests`,
...
function runTest(file) {
  ...
  if (frontendFramework === 'angular') {
    ...
    result = (0, child_process_1.execSync)(`npx jest ${relativeTestFilePath}`, {
      stdio: 'pipe',
    });
    stdout = result.toString();
    process.chdir(rootDir);
...
function checkIfJestTestPasses(testFile) {
  ...
  if (
    ...
    (result.numFailedTestSuites === 1 &&
      result.testResults[0].message.includes(
...
function checkIfAngularTestsPass(testFile) {
  ...
  let output;
  try {
    output = (0, child_process_1.execSync)(
...
function save(testFilePath, testCode) {
  ...
  (0, child_process_1.execSync)(
    `git add ${testFilePath} && git stash push ${testFilePath}`,
  );
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    for (const directory in filesByDirectory) {
      ...
      while (filesInDirectory.length > 0) {
        ...
        // @ts-ignore
        tsFileContent =
          tsFileContent === null || tsFileContent === void 0
            ? void 0
            : tsFileContent.split('function detectProjectType()')[0];
        //console.log(tsFileContent)
        console.log('tsFile: ' + tsFile);
        const response = yield generateTest(
          diff,
          tsFile,
          tsFileContent,
          htmlFile,
        ...
        const { fixedAllErrors, runResults, apiError, fixedTest } =
          yield fixErrors(testFile, testVersion, diff, tsFile, tsFileContent);
        if (apiError) {
        ...
        if (fixedAllErrors) {
          ...
          if (frontendFramework === 'angular') {
            testContentWithErrors.push({
              test: testFile,
              testContent: fixedTest,
            });
          }
        }
      }
